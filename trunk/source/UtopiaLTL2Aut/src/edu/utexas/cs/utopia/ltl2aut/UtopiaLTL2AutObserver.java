...
public class UtopiaLTL2AutObserver implements IUnmanagedObserver {
	...
	public UtopiaLTL2AutObserver(final IUltimateServiceProvider services) {
	...
	public NWAContainer getPropertyAut(VerificationProperty property) throws Throwable {
		...
		LTL2BAExecutor ltl2ba = new LTL2BAExecutor(services);
		final CodeBlockFactory cbf = CodeBlockFactory.getFactory(services.getStorage());
