...
import edu.tsinghua.ss.thufv.ltl2aut.preferences.PreferenceInitializer;
 ...
 */
public class ThufvLTL2Aut implements IGenerator, ISource {
	...
	private ThufvLTL2AutObserver mObserver;
	...
	public void init() {
		mProcess = false;
		mUseful = 0;
		mObserver = new ThufvLTL2AutObserver(mServices);
	}
	...
	public void setInputDefinition(final ModelType graphType) {
		...
		case "edu.tsinghua.ss.thufv.specLang":	
			mProcess = true;
			mUseful++;
			break;
		default:
