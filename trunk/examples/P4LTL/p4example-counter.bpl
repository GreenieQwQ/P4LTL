...
procedure {:inline 1} egress()
	modifies drop, hdr.ethernet.srcAddr, standard_metadata.egress_port, counter;
{
...
procedure {:inline 1} ingress()
	modifies drop, forward, hdr.ethernet.dstAddr, hdr.ipv4.dstAddr, hdr.ipv4.ttl, meta.routing_metadata.nhop_ipv4, standard_metadata.egress_spec, counter;
{
...
procedure {:inline 1} main()
	modifies drop, forward, hdr.ethernet.dstAddr, hdr.ethernet.etherType, hdr.ethernet.srcAddr, hdr.ipv4.diffserv, hdr.ipv4.dstAddr, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.hdrChecksum, hdr.ipv4.identification, hdr.ipv4.ihl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.totalLen, hdr.ipv4.ttl, hdr.ipv4.version, isValid, meta.routing_metadata.nhop_ipv4, standard_metadata.egress_port, standard_metadata.egress_spec, counter;
{
        drop := false;
        forward := false;
        call havocProcedure();
...
procedure mainProcedure()
	modifies drop, emit, forward, forward_0.action_run, hdr.ethernet.dstAddr, hdr.ethernet.etherType, hdr.ethernet.srcAddr, hdr.ipv4.diffserv, hdr.ipv4.dstAddr, hdr.ipv4.flags, hdr.ipv4.fragOffset, hdr.ipv4.hdrChecksum, hdr.ipv4.identification, hdr.ipv4.ihl, hdr.ipv4.protocol, hdr.ipv4.srcAddr, hdr.ipv4.totalLen, hdr.ipv4.ttl, hdr.ipv4.version, ipv4_lpm_0.action_run, isValid, meta.routing_metadata.nhop_ipv4, send_frame_0.action_run, standard_metadata.egress_port, standard_metadata.egress_spec, counter;
{
